...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('tarinika_scraper.log'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger(__name__)

class TarinikaScraper:
    BASE_URL = "https://www.tarinika.in/collections/tribal-collection/products.json"
    ...
    def process_product(self, item):
        ...
        try:
            ...
            product_url = f"https://www.tarinika.in/products/{handle}" if handle else ""
    ...
    def run(self):
        ...
        logger.info("Starting scrape for Tarinika Jewellery (Tribal Collection)...")
    ...
    def save_data(self, products):
        ...
        output_file = self.base_output_dir / "tarinika_products.json"
...
if __name__ == "__main__":
    ...
    output_dir = "/Volumes/Macintosh HD/tanishq_scraper/tribal/tarinika/data"
    
    scraper = TarinikaScraper(base_output_dir=output_dir)
    scraper.run()
