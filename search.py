...
class Config:
    ...
    OUTPUT_DIR        = "/workspace/Multimodal-pipeline/search_results_2"
...
class UnifiedJewelrySearcher:
    ...
    def sarvam_stt(self, audio_path):
        ...
        # ── FIX: Added .webm for browser MediaRecorder recordings ─────────
        mime_map = {
            '.mp3':  'audio/mpeg',
            '.wav':  'audio/wav',
            '.m4a':  'audio/x-m4a',
            '.ogg':  'audio/ogg',
            '.webm': 'audio/webm',   # browser mic recordings from Web UI
        }
